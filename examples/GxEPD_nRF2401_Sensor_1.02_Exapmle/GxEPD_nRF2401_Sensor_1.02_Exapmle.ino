 ...
 * @date      2022-05-31
 * @note      Using TTGO MINI E-Paper 1.02" epaper , Send sensor value via nRF24  ,
...
const uint8_t button_pin[BUTTON_COUNT] = BUTTONS;
Preferences pref;
...
void sleep()
{
    ...
    */
    ...
    // Wake up within the configured time frame
...
float getSensorValue()
{
    ...
    * */
    ...
    if ( temp < 1 ) {
        // Return false data if no sensor detected
